            ...
            <form onSubmit={handleCreateRoom} class="flex flex-col gap-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Show when={createRoomResource.error}>
                    <div class="col-span-2 text-red-400 text-sm mt-1">
                      {createRoomResource.error?.message || 'Falha ao criar sala. Tente novamente.'}
                    </div>
                  </Show>
                </div>
              </div>
              <div class="flex justify-end gap-3 mt-4">
                ...
                <button 
                  type="submit" 
                  disabled={createRoomResource.loading}
                  class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors text-sm font-medium shadow-md disabled:opacity-50 disabled:cursor-not-allowed min-w-[80px]"
                >
                  <Show when={createRoomResource.loading} fallback="Criar">
                    Criando...
                  </Show>
                </button>
              </div>
